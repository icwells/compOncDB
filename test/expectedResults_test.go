...
func getCanisResults() *dataframe.Dataframe {
	...
	s := [][]string{
		...
		{"3", "male", "24", "0", "-1", "0", "1", "3", "Coyote", "1-Dec", "2011", "Lymphoma lymph nodes 2 year old male", "1", "0", "-1", "-1", "1", "1", "lymphoma", "Round Cell", "lymph nodes", "Animalia", "Chordata", "Mammalia", "Carnivora", "Canidae", "Canis", "Canis latrans", "Coyote", "NWZP", "0", "0", "0", "-1", "1"},
