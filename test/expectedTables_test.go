...
func getPatient() *dataframe.Dataframe {
	...
	s := [][]string{
		...
		{"1", "male", "-1", "-1", "1", "1", "Coyote", "12-Dec", "2001", "Biopsy: NORMAL BLOOD SMEAR"},
		{"2", "NA", "-1", "-1", "1", "2", "Coyote", "13-Jan", "2001", "ERYTHROPHAGOCYTOSIS"},
		{"3", "male", "24", "-1", "1", "3", "Coyote", "1-Dec", "2001", "Lymphoma lymph nodes 2 year old male"},
		{"4", "NA", "-1", "-1", "1", "4", "Coyote", "1-Dec", "2001", "HIPOTOMAS TOXIC HIPOTOPATHY autopsy"},
		{"5", "NA", "-1", "-1", "1", "5", "Coyote", "1-Dec", "2001", "MICRONED HEPATITIS"},
		{"6", "NA", "-1", "-1", "1", "6", "Coyote", "1-Dec", "2001", "NA"},
		{"7", "NA", "-1", "-1", "1", "7", "Coyote", "1-Dec", "2001", "ASPERGILLOSIS"},
		{"8", "NA", "-1", "-1", "2", "8", "wolf", "1-Dec", "2001", "Ovarian adenoma"},
		{"9", "NA", "-1", "-1", "2", "9", "wolf", "1-Dec", "2001", "NA"},
		{"10", "female", "0", "-1", "2", "10", "wolf", "NA", "2001", "skin biopsy:  squamous cell carcinoma; in situ"},
		{"11", "female", "156", "-1", "2", "11", "wolf", "NA", "2001", "Uterus:  Endometrial carcinoma with metastatis"},
		{"12", "male", "60", "-1", "2", "12", "wolf", "NA", "2001", "NA"},
		{"13", "female", "126", "1", "2", "13", "wolf", "NA", "2001", "Spayed biopsy"},
		{"14", "female", "0", "-1", "2", "14", "wolf", "NA", "2001", "NA"},
		{"15", "NA", "192", "-1", "2", "15", "GRAY WOLF", "NA", "2001", "16 month old"},
		{"16", "female", "132", "-1", "2", "16", "GRAY WOLF", "NA", "2001", "Malignant liver adenocarcinoma"},
		{"17", "male", "144", "1", "2", "17", "GRAY WOLF", "NA", "2001", "neutered"},
		{"18", "male", "-1", "0", "2", "18", "GRAY WOLF", "30463", "2001", "NA"},
		{"19", "male", "-1", "0", "2", "19", "GRAY WOLF", "32688", "2001", "NA"},
	}
	return setDF(s)
}
