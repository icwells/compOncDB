...
func getPatient() *dataframe.Dataframe {
	...
	s := [][]string{
		H.Patient,
		{"1", "male", "-1", "-1", "-1", "1", "1", "Coyote", "12-Dec", "2011", "Biopsy: NORMAL BLOOD SMEAR"},
		{"2", "NA", "-1", "-1", "-1", "1", "2", "Coyote", "13-Jan", "2011", "ERYTHROPHAGOCYTOSIS"},
		{"3", "male", "24", "0", "-1", "1", "3", "Coyote", "1-Dec", "2011", "Lymphoma lymph nodes 2 year old male"},
		{"4", "NA", "-1", "-1", "-1", "1", "4", "Coyote", "1-Dec", "2011", "HIPOTOMAS TOXIC HIPOTOPATHY autopsy"},
		{"5", "NA", "-1", "-1", "-1", "1", "5", "Coyote", "1-Dec", "2011", "MICRONED HEPATITIS"},
		{"6", "NA", "-1", "-1", "-1", "1", "6", "Coyote", "1-Dec", "1999", "NA"},
		{"7", "NA", "-1", "-1", "-1", "1", "7", "Coyote", "1-Dec", "1999", "ASPERGILLOSIS"},
		{"8", "NA", "-1", "-1", "-1", "2", "8", "wolf", "1-Dec", "1999", "Ovarian adenoma"},
		{"9", "NA", "-1", "-1", "-1", "2", "9", "wolf", "1-Dec", "1999", "NA"},
		{"10", "female", "0", "1", "-1", "2", "10", "wolf", "NA", "1990", "skin biopsy:  squamous cell carcinoma; in situ"},
		{"11", "female", "156", "0", "-1", "2", "11", "wolf", "NA", "1990", "Uterus:  Endometrial carcinoma with metastatis"},
		{"12", "male", "60", "0", "-1", "2", "12", "wolf", "NA", "1990", "NA"},
		{"13", "female", "126", "0", "1", "2", "13", "wolf", "NA", "2016", "Spayed biopsy"},
		{"14", "female", "0", "1", "-1", "2", "14", "wolf", "NA", "2016", "NA"},
		{"15", "NA", "192", "0", "-1", "2", "15", "GRAY WOLF", "NA", "2016", "16 month old"},
		{"16", "female", "132", "0", "-1", "2", "16", "GRAY WOLF", "NA", "2016", "Malignant liver adenocarcinoma"},
		{"17", "male", "144", "0", "1", "2", "17", "GRAY WOLF", "NA", "2016", "neutered"},
		{"18", "male", "-1", "-1", "0", "2", "18", "GRAY WOLF", "30463", "2016", "NA"},
		{"19", "male", "-1", "-1", "0", "2", "19", "GRAY WOLF", "32688", "2016", "NA"},
	}
	return setDF(0, s)
}
