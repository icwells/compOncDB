...
var (
	...
	cr         = extract.Flag("cancerRate", "Calculates cancer rates for species/locations/tumor types with greater than min entries (specify 'species', 'location', or 'type').").Default("nil").String()
