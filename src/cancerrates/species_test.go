...
func locationSlice() [][]string {
	...
	var ret [][]string
	ret = append(ret, []string{"100", "5", "50", "10", "5", "0.1", "10", "2", "0.04", "0.4", "3", "0.06", "0.6", "10.00", "10.00", "2", "3", "2", "3", "1", "0", ""})
	ret = append(ret, []string{"110", "5", "100", "10", "5", "0.05", "10", "2", "0.02", "0.4", "3", "0.03", "0.6", "10.00", "10.00", "2", "3", "2", "3", "1", "0", ""})
	return ret
}
