...
func getExpectedRecords() [][]string {
	...
	expected = append(expected, []string{"100", "50", "50", "30", "25", "0.5", "18", "5", "0.1", "0.3333333333333333", "10", "0.2", "0.6666666666666666", "20.00", "10.00", "50", "50", "15", "10", "20", "0", "0"})
	expected = append(expected, []string{"110", "100", "100", "35", "30", "0.3", "13", "3", "0.03", "0.38461538461538464", "5", "0.05", "0.6153846153846154", "9.00", "10.00", "50", "70", "12", "18", "5", "0", "0"})
	expected = append(expected, []string{"50", "50", "50", "0", "0", "0", "0", "0", "0", "NA", "0", "0", "NA", "12.00", "NA", "25", "35", "50", "0", "0", "0", "0"})
	return expected
}
